...
export default async function PokedexLayout({ children }) {
  ...
  return (
    <div data-testid="pokedex-container" className="flex flex-row h-full w-full">
      <div
      ...
      <div
        className="flex w-full m-4 p-4 pt-12 border-4 border-gray-500 bg-gray-300 rounded-md"
